...
public class EmployeeService {
    ...
    // ConcurrentHashMap provides a simple thread-safe in-memory store keyed by employee UUID.
    private final Map<UUID, Employee> employees = new ConcurrentHashMap<>();

    public EmployeeService() {
        // Seed the in-memory store with a mock employee so retrieval endpoints have initial data.
     ...
     *
     * The UUID and full name are generated by the service rather than supplied by the client.
     *
